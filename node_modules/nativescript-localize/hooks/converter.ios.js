...
const resource_ios_1 = require("../src/resource.ios");
class ConverterIOS extends converter_common_1.ConverterCommon {
    ...
    writeStrings(languageResourcesDir, resourceFileName, strings, encodeKeys) {
        let content = "";
        strings.forEach((value, key) => {
            content += `"${encodeKeys ? resource_ios_1.encodeKey(key) : key}" = "${resource_ios_1.encodeValue(value)}";\n`;
        });
    ...
    writeInfoPlist(infoPlistValues) {
        ...
        if (resourceChanged) {
            ...
            this.emit(converter_common_1.ConverterCommon.CONFIGURATION_CHANGED_EVENT);
        }
    }
}
